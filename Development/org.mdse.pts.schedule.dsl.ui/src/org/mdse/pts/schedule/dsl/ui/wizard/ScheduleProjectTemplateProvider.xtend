 ...
 */
class ScheduleProjectTemplateProvider implements IProjectTemplateProvider {
...
<p>This is a parameterized hello world for Schedule. You can set a parameter to modify the content in the generated file
...
final class HelloWorldProject {
	...
	override generateProjects(IProjectGenerator generator) {
		generator.generate(new PluginProjectFactory => [
			...
			folders += "src"
			addFile('''src/«path»/Model.schedule''', '''
				/*
