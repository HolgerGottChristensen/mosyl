	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TimetablePackage.ARRIVAL: {
				...
				if (result == null) result = caseJuncture(arrival);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
