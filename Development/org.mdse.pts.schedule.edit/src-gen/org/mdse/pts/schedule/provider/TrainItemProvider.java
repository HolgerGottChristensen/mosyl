...
/**
 * This is the item provider adapter for a {@link org.mdse.pts.schedule.Train} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TrainItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulePackage.Literals.TRAIN__TRAINREFERENCE);
			childrenFeatures.add(SchedulePackage.Literals.TRAIN__STARTTIMES);
			childrenFeatures.add(SchedulePackage.Literals.TRAIN__STOPS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Train_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchedulePackage.Literals.TRAIN__TRAINREFERENCE,
				 ScheduleFactory.eINSTANCE.createTrainReference()));

		newChildDescriptors.add
			(createChildParameter
				(SchedulePackage.Literals.TRAIN__STARTTIMES,
				 ScheduleFactory.eINSTANCE.createStartTime()));

		newChildDescriptors.add
			(createChildParameter
				(SchedulePackage.Literals.TRAIN__STOPS,
